...
- **Тестирование**: Embedded тесты от QLP https://github.com/QuantumLeaps/Embedded-Test
- **Срезы**: Использование кольцевых срезов вместо прямого копирования буфера. https://github.com/ferrero222/ringslice/tree/dev
