 ...
 ** @return true - proc started, false - smthg is wrong
 ******************************************************************************/
bool atl_mdl_modem_init(const atl_entity_cb_t cb, const void* const param, const void* const ctx)
{
  atl_item_t items[] = //[REQ][PREFIX][FORMAT][RPT][WAIT][STEPERROR][STEPOK][CB][...##VA_ARGS]
  {
 ...
 *  @brief ceng cb
 */
void atl_mdl_general_ceng_cb(ringslice_t rs_data, void* const data)
{
