...
bool atl_mdl_rtd(const atl_entity_cb_t cb, const void* const param, void* const ctx)
{
  ...
  {   
    ...
    ATL_ITEM("AT+GMM"ATL_CMD_CRLF,       NULL, 2, 150, 0, 1, NULL,               "%15[^\x0d]", ATL_ARG(atl_mdl_rtd_t, modem_id)),  
    ...
    ATL_ITEM("AT+CENG?"ATL_CMD_CRLF,     NULL, 2, 600, 0, 0, atl_mdl_general_ceng_cb,    NULL, ATL_NO_ARG),                         
  };
