  ...
  { //ATL_CORE=====================================================================
    ...
    TEST("atl_entity_enqueue()/atl_entity_dequeue() composite AT`s") {
      ...
      atl_item_t items[] = //[REQ][PREFIX][PARCE_TYPE][RPT][WAIT][STEPERROR][STEPOK][CB][FORMAT][...##VA_ARGS]
      {
        ...
        ATL_ITEM(ATL_CMD_SAVE"AT+GMM"ATL_CMD_CRLF,       NULL, ATL_PARCE_SIMCOM, 2, 150, 0, 1, NULL,               "%15[^\x0d]", ATL_ARG(atl_mdl_rtd_t, modem_id)),  
        ATL_ITEM("AT+GMR"ATL_CMD_CRLF,                   NULL, ATL_PARCE_SIMCOM, 2, 150, 0, 1, NULL,      "Revision:%29[^\x0d]", ATL_ARG(atl_mdl_rtd_t, modem_rev)),                
        ATL_ITEM("AT+CCLK?"ATL_CMD_CRLF,                 NULL, ATL_PARCE_SIMCOM, 2, 150, 0, 1, NULL,      "+CCLK: \"%21[^\"]\"", ATL_ARG(atl_mdl_rtd_t, modem_clock)),          
        ATL_ITEM("AT+CCID"ATL_CMD_CRLF,   ATL_CMD_SAVE"+CCLK", ATL_PARCE_SIMCOM, 2, 150, 0, 1, NULL,               "%21[^\x0d]", ATL_ARG(atl_mdl_rtd_t, sim_iccid)),             
        ATL_ITEM("AT+COPS?"ATL_CMD_CRLF,  ATL_CMD_SAVE"+COPS", ATL_PARCE_SIMCOM, 2, 150, 0, 1, NULL, "+COPS: 0, 0,\"%49[^\"]\"", ATL_ARG(atl_mdl_rtd_t, sim_operator)),            
        ATL_ITEM("AT+CSQ"ATL_CMD_CRLF,     ATL_CMD_SAVE"+CSQ", ATL_PARCE_SIMCOM, 2, 150, 0, 1, NULL,                 "+CSQ: %d", ATL_ARG(atl_mdl_rtd_t, sim_rssi)),             
